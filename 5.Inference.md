...
dock.error.ExposeErrorDist dft -b ../../inputs/dft -k orbital -p 10
```
...
``` bash
cd band/target_material
dock.band.CalcData -p 10 .
```

The `-p 10` specifies 10-core parallelization over k points and can be adjusted according to available computational resources.
