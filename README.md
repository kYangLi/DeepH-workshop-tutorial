...
**NOTE:** This tutorial utilizes a JAX-based ([GitHub](https://github.com/jax-ml/jax)) refactoring of DeepH, distinct from the legacy implementation available in [our public repository](https://github.com/mzjb/DeepH-pack).
