...
> **Note:** This tutorial utilizes a JAX-based refactoring of DeepH ([GitHub](https://github.com/jax-ml/jax)), distinct from the legacy implementation available in [our public repository](https://github.com/mzjb/DeepH-pack).
