...
```bash
dock.io.OpenMXToDeepH --openmx ./openmx_calculations --deeph ./dft
```
...
```bash
dock.io.SIESTAToDeepH --siesta ./siesta_calculations --deeph ./dft
```
...
```bash
dock.io.AbacusToDeepH  --abacus ./abacus_calculations --deeph ./dft
```
