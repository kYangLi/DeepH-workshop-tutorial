...
> **Note:**
> - The `deepx_dock-1.0.0-py3-none-any.whl` file is a pre-provided wheel package. You can locate it in `~/workshop/2.Installation`.
...
> **Note:**
> - The `./deepx-1.0.4+light-py3-none-any.whl` file is a pre-provided wheel package. You can locate it in `~/workshop/2.Installation`.
