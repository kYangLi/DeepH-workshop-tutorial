...
```bash
cd ~/workshop/Data/6.UMM_Odyssey/1.Do_Inference
sbatch submit.sh
```
...
```bash
cd ~/workshop/Data/6.UMM_Odyssey/1.Do_Inference/outputs/<timestamp>
...
```bash
cd ~/workshop/Data/6.UMM_Odyssey/2.Lets_Finetune_It
sbatch submit.sh
```
...
```text
(deeph) scze085@ln01:~/workshop/Data/6.UMM_Odyssey/2.Lets_Finetune_It$ cat /home/dppa443/workshop/Data/6.UMM_Odyssey/2.Lets_Finetune_It/outputs/20
25-11-20_22-00-38/deepx.log
[ 11.20-22:00:45 ]
[ 11.20-22:00:45 ]            Welcome to DeepH-pack (deepx)!
[ 11.20-22:00:45 ]                  Version 1.0.4
[ 11.20-22:00:45 ]
[ 11.20-22:00:45 ] ...................................................
...
[ 11.20-22:00:56 ] [rawdata] Read in features from json: `/home/dppa443/workshop/Data/6.UMM_Odyssey/2.Lets_Finetune_It/inputs/dft/features.json`.
[ 11.20-22:00:56 ] [graph] Establishing the graph from the DFT raw data: `/home/dppa443/workshop/Data/6.UMM_Odyssey/2.Lets_Finetune_It/inputs/dft`.
...
[ 11.20-22:01:23 ] [graph] Saved the graph set in memory to `/home/dppa443/workshop/Data/6.UMM_Odyssey/2.Lets_Finetune_It/inputs/graph/MoTe2_100_Op
...
[ 11.20-22:02:43 ] [model] We will save the model into `/home/dppa443/workshop/Data/6.UMM_Odyssey/2.Lets_Finetune_It/outputs/2025-11-20_22-00-38/model`. The best model will be saved. The latest model (keep `1` each `5` epoch) will be saved.
...
[ 11.20-22:04:32 ] [model] We are loading the `best` model inside `/home/dppa443/workshop/Data/6.UMM_Odyssey/_.DeepH-UMM.D20k-P48M`. We are using the new training dataset, and applying new optimizer.
