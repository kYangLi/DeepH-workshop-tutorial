...
```bash
cd ~/workshop/4.Training/H2O_5K_FHI-aims/inputs
...
```bash
cd ~/workshop/4.Training/H2O_5K_FHI-aims
...
```bash
cd ~/workshop/4.Training/Graphene_500_ABACUS
sbatch submit.sh
```
...
```bash
cd ~/workshop/4.Training/MoS2_500_OpenMX
sbatch submit.sh
```
